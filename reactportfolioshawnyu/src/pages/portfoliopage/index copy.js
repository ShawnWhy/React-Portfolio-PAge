...
const PortfolioPage = function(){
    ...
    function showProject4(){
      ...
      useEffect(
          ...
          setTimeout(() => {
              setIconState({...iconState, one:"jumpUp"})
        },0)
        setTimeout(() => {
            setIconState({...iconState, one:"jumpUp",two:"jumpUp"})
      },200)
      setTimeout(() => {
        setIconState({...iconState, one:"jumpUp",two:"jumpUp",three:"jumpUp"})
  },300)
  setTimeout(() => {
    setIconState({...iconState, one:"jumpUp",two:"jumpUp",three:"jumpUp",four:"jumpUp"})
},400)
...
return(
    <div>
        <div className={(icon1==="invisible" ? "stayIcon" : "offseticon") + " row "+iconState.one}>
        ...
        <div className={(icon2==="invisible" ? "stayIcon" : "offseticon") + " row "+iconState.two}>
        ...
        <div className={(icon3==="invisible" ? "stayIcon" : "offseticon") + " row "+iconState.three}>
        ...
        <div className={(icon4==="invisible" ? "" : "offseticon") + " row "+iconState.four}>
